...
export function getAcademics(params,cb) {
    API.GET(PATHS.ACADEMICS, {}, params,
        function (res) {
            cb(res)
...
export function getInstiLife(params,cb) {
    API.GET(PATHS.INSTILIFE, {}, params,
        function (res) {
            cb(res)
...
export function getSpotLight(params,cb) {
    API.GET(PATHS.SPOTLIGHT, {}, params,
        function (res) {
            cb(res)
...
export function postNewsletter(params,cb){
    API.POST(PATHS.NEWSLETTER,params,{},
        function (res) {
            cb(res);
        }
    )
